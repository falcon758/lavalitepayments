<div class="btn-group payments-transaction">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[seller_id]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.seller_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[amount]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.amount')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[tax_amount]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.tax_amount')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[tax_type]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.tax_type')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[type]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.type')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[bank_ref]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.bank_ref')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[details]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.details')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[date_from]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.date_from')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[date_to]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.date_to')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[commission]" class="col-sm-2 control-label">
                                        {!! trans('payments::transaction.label.commission')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".payments-transaction .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/payments.transaction.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".payments-transaction .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.payments-transaction .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'payments.transaction.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#payments-transaction-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#payments-transaction-list .btn-reset-filter').css('display', 'none');
