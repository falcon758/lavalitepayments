<div class="btn-group payments-payment">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[order_id]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.order_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[client_id]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.client_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[method]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.method')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[address]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.address')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[code]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.code')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[tracking_id]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.tracking_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[bank_ref_no]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.bank_ref_no')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[card_name]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.card_name')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[currency]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.currency')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[amount]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.amount')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[trans_date]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.trans_date')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[custom_field]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.custom_field')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[description]" class="col-sm-2 control-label">
                                        {!! trans('payments::payment.label.description')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".payments-payment .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/payments.payment.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".payments-payment .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.payments-payment .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'payments.payment.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#payments-payment-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#payments-payment-list .btn-reset-filter').css('display', 'none');
